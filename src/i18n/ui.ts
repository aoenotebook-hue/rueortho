...
const ui = {
  th: {
    ...
    'search.noResultsHint': 'ลองใช้คำที่สั้นลง หรือเลือกดูจากรายการด้านล่าง',
    'search.browseAll': 'ดูโรคและภาวะทั้งหมด',
    'search.unavailable': 'ขออภัย ระบบค้นหาขัดข้องชั่วคราว ระหว่างนี้ลองเลือกจากรายการด้านล่าง',
    'search.browseArticles': 'ดูบทความและวิดีโอทั้งหมด',
    'search.noScript': 'ระบบค้นหาต้องใช้จาวาสคริปต์ หากปิดไว้ ยังเปิดดูเนื้อหาทั้งหมดได้จากรายการด้านล่าง',
    ...
    'error.404.body': 'หน้าที่คุณเปิดอาจถูกย้ายหรือไม่มีอยู่แล้ว ลองค้นหาหรือกลับไปที่หน้ารวมบทความ',
  },
  ...
  en: {
    ...
    'search.noResultsHint': 'Try a shorter word, or start from one of the lists below.',
    'search.browseAll': 'Browse all conditions',
    'search.unavailable': 'Search is temporarily unavailable. These lists are another way in.',
    'search.browseArticles': 'All articles and videos',
    'search.noScript': 'Search needs JavaScript. With it switched off, these lists are another way to everything on the site.',
