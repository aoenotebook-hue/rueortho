...
{/* SAMPLE — drafted by an AI assistant, not medically reviewed.
    sources is deliberately empty — this environment cannot reach external sites to verify a link,
    so no unverifiable citation was written in. The author selects and adds them. */}
