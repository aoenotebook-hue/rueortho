...
{/* SAMPLE — the sections on the injury itself, diagnosis and the surgery decision were drafted by
    an AI assistant, because the app covers recovery only. The post-operative sections and the run
    and return-to-sport criteria are the author's own English, from his ACL Reconstruction Recovery app.
