...
cardSummary: 'A cruciate ligament torn on a twist. The knee swells fast and gives way.'
keywords:
  - 'ACL tear'
...
author: 'sorawut'
reviewedBy: 'sorawut'
heroImage: '../../../assets/conditions/acl-injury/acl-injury-hero.jpg'
heroImageAlt: 'A man in sportswear pulls up mid-turn on a pitch and grips his knee, where a red mark sits at the front of the joint'
redFlags:
...
import heelProp from '../../../assets/conditions/acl-injury/heel-prop.webp';
import iceAndElevation from '../../../assets/conditions/acl-injury/ice-and-elevation.webp';
import crutches from '../../../assets/conditions/acl-injury/crutches.webp';
import showering from '../../../assets/conditions/acl-injury/showering.webp';
import sleepHeelOnPillow from '../../../assets/conditions/acl-injury/sleep-heel-on-pillow.webp';
import deskWork from '../../../assets/conditions/acl-injury/desk-work.webp';
import noSmoking from '../../../assets/conditions/acl-injury/no-smoking.webp';
import anatomyImage from '../../../assets/conditions/acl-injury/acl-injury-anatomy.jpg';
import careImage from '../../../assets/conditions/acl-injury/acl-injury-care.jpg';
...
<Figure
  src={anatomyImage}
  alt="Front-view diagram of the knee showing the cruciate ligament in the centre in orange, torn through the middle, with the two menisci in blue on either side"
  caption="The cruciate sits in the middle of the joint, and is what stops the knee sliding forward and twisting."
...
<Figure
  src={careImage}
  alt="Three panels: a man sits on a mat with a rolled towel under his knee; stands on one leg with a hand on a rail; jogs outdoors"
  caption="Recovery runs from muscle control, to balance, and only then to taking impact again."
  attribution="Illustration: Assoc. Prof. Sorawut Thamyongkit, M.D."
/>
...
<Figure
  src={heelProp}
  alt="A woman sits on a treatment couch with a rolled towel under the heel of the operated leg and nothing under the knee, which rests straight"
  caption="The towel goes under the heel, never under the knee."
  attribution="Image from the ACL Reconstruction Recovery app by Assoc. Prof. Sorawut Thamyongkit, M.D. · AI-generated image"
/>
...
<Figure
  src={iceAndElevation}
  alt="A woman reclines on a couch with an ice pack wrapped around the knee and the leg raised on a wedge cushion"
  caption="Ice with the leg raised, 15–20 minutes at a time."
  attribution="Image from the ACL Reconstruction Recovery app by Assoc. Prof. Sorawut Thamyongkit, M.D. · AI-generated image"
/>
...
<Figure
  src={crutches}
  alt="A woman walks with two crutches and a knee brace, taking an even step"
  caption="Even, unhurried steps, with the knee straightening as the heel lands."
  attribution="Image from the ACL Reconstruction Recovery app by Assoc. Prof. Sorawut Thamyongkit, M.D. · AI-generated image"
/>
...
<Figure
  src={showering}
  alt="A woman sits on a shower chair pulling a clear waterproof cover up over the operated leg"
  caption="Water should not run straight onto the wounds until they have closed."
  attribution="Image from the ACL Reconstruction Recovery app by Assoc. Prof. Sorawut Thamyongkit, M.D. · AI-generated image"
/>

<Figure
  src={sleepHeelOnPillow}
  alt="A woman lies in bed with a pillow under the heel of the operated leg and nothing under the knee"
  caption="Pillow under the heel, not under the knee."
  attribution="Image from the ACL Reconstruction Recovery app by Assoc. Prof. Sorawut Thamyongkit, M.D. · AI-generated image"
/>
...
<Figure
  src={deskWork}
  alt="A woman works at a laptop with the operated leg resting on a low stool and a pair of crutches leaning against the wall behind her"
  caption="Most people return to desk work within a few weeks. Ask your surgeon about your own case."
  attribution="Image from the ACL Reconstruction Recovery app by Assoc. Prof. Sorawut Thamyongkit, M.D. · AI-generated image"
/>

<Figure
  src={noSmoking}
  alt="A no-smoking sign: a red circle and bar crossing out a cigarette and an e-cigarette"
  caption="Smoking and nicotine products reduce blood supply to the healing graft."
  attribution="Image from the ACL Reconstruction Recovery app by Assoc. Prof. Sorawut Thamyongkit, M.D. · AI-generated image"
/>
