...
cardSummary: 'A finger tendon catches in its sheath, so the finger sticks or locks.'
keywords:
  - 'trigger finger'
  - 'finger locking'
  - 'finger catching'
...
author: 'sorawut'
reviewedBy: 'sorawut'
heroImage: '../../../assets/conditions/trigger-finger/trigger-finger-hero.jpg'
...
import anatomyImage from '../../../assets/conditions/trigger-finger/trigger-finger-anatomy.jpg';
import careImage from '../../../assets/conditions/trigger-finger/trigger-finger-care.jpg';
...
<Figure
  src={anatomyImage}
  alt="Diagram of the hand and fingers showing the tendons passing through a series of sheaths, with one sheath at the base of a finger thickened and picked out in red"
  caption="A thickened pulley at the base of the finger is where the tendon catches."
...
<Figure
  src={careImage}
  alt="Three parts: a top row showing five hand positions in sequence from open palm to closed fist; below left, a woman writing with a thick-barrelled pen beside a crossed-out thin pen; below right, sleeping while wearing a finger splint"
  caption="Gliding the tendon, a thicker grip to hold, and a splint at night."
  attribution="Illustration: Assoc. Prof. Sorawut Thamyongkit, M.D."
/>
...
<ExerciseCard
  ...
  sets="3 rounds"
  reps="5 times"
  hold="hold each position 3 seconds"
...
<ExerciseCard
  title="Blocked finger extension"
  sets="2 rounds"
  reps="10 times"
  image="/images/exercises/blocked-finger-extension.webp"
  imageAlt="One hand rests palm down while the other holds the knuckle of a finger steady and the end of that finger straightens"
  imageWidth={765}
  imageHeight={1024}
  imageAttribution="Illustration: Assoc. Prof. Sorawut Thamyongkit, M.D."
>
