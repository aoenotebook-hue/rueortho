...
cardSummary: 'Tendons, capsule or joint. The movements that hurt narrow it down.'
keywords:
  - 'shoulder pain'
  - 'cannot lift arm'
...
author: 'sorawut'
reviewedBy: 'sorawut'
heroImage: '../../../assets/conditions/shoulder-pain/shoulder-pain-hero.jpg'
heroImageAlt: 'An older woman reaches up to a shelf while supporting her upper arm with the other hand, a red glow over the shoulder'
redFlags:
...
import anatomyImage from '../../../assets/conditions/shoulder-pain/shoulder-pain-anatomy.jpg';
import careImage from '../../../assets/conditions/shoulder-pain/shoulder-pain-care.jpg';
...
<Figure
  src={anatomyImage}
  alt="Front-view diagram of the shoulder with three red marks: at the joint on top of the collarbone, beneath the bony point on the outside, and at the rim of the shoulder joint"
  caption="These three sore points come from different causes, so the location is an important clue."
...
<Figure
  src={careImage}
  alt="Two panels: a clinician supports and gently raises the arm of a patient sitting on an examination couch; the patient stands side-on to a wall and walks her hand up it"
  caption="Checking how far the shoulder moves usually comes before any programme starts."
  attribution="Illustration: Assoc. Prof. Sorawut Thamyongkit, M.D."
/>
