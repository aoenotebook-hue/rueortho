...
author: 'sorawut'
reviewedBy: 'sorawut'
heroImage: '../../../assets/conditions/knee-osteoarthritis/knee-osteoarthritis-hero.jpg'
heroImageAlt: 'An older woman pushes up from a chair, one hand on the arm rest and the other on her knee, where a red mark sits'
redFlags:
...
import anatomyImage from '../../../assets/conditions/knee-osteoarthritis/knee-osteoarthritis-anatomy.jpg';
import careImage from '../../../assets/conditions/knee-osteoarthritis/knee-osteoarthritis-care.jpg';
...
<Figure
  src={anatomyImage}
  alt="Front-view diagram of the knee showing thinned cartilage surfaces and roughened, spurred joint edges, with the worn areas picked out in orange"
...
<Figure
  src={careImage}
  alt="Three panels: an older woman practises standing up from a chair; rides a stationary bike; walks in a park"
  attribution="Illustration by Assoc. Prof. Sorawut Thamyongkit, M.D."
/>
